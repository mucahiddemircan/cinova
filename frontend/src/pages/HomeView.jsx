 ...
 * Ana sayfa bileşeni.
 *
 * Trend içerikler, popüler oyuncular/yönetmenler ve
 * oturum açmış kullanıcılar için kişiselleştirilmiş öneriler.
 */
...
export default function HomeView({ contents, people, loading, user }) {
    ...
    const [personalRecs, setPersonalRecs] = useState(() => {
        ...
        try {
            ...
            // Eski cache formatını tespit et ve temizle
    ...
    useEffect(() => {
        if (user) {
            // Kullanıcı bazlı cache kontrolü
            ...
            // Veri yoksa yükleme durumunu başlat
            setRecsLoading(true);
    ...
    }, [user?.id]); // Sadece kullanıcı ID'si değiştiğinde (veya ilk yüklemede) çalışır
        ...
        <div className="animate-fade-in flex flex-col gap-2">
            ...
            {user && (
                <>
                    ...
                    {/* Öneriler yüklenirken skeleton göster - Sadece yükleme devam ediyorken ve veri yokken */}
