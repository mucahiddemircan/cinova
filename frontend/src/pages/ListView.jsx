/**
 * Liste görünüm sayfası bileşeni.
 *
 * Kullanıcı listelerini (izlenecekler, tamamlananlar vb.) veya
 * etkileşim listelerini (beğenilenler) görüntüler. Liste ve ızgara
 * görünüm modları, sıralama ve sağ tık bağlam menüsü desteği sunar.
 */
...
export default function ListView({ user: currentUser, type: propType }) {
    ...
    useEffect(() => {
        const handleStatusChange = (e) => {
            ...
            // 4'lü grup (Watchlist/Watched) kontrolü
            if (isWatchlistGroup) {
            ...
            // 2'li grup (Like/Dislike) kontrolü
