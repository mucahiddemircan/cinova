...
/**
 * Dil bazlı yönlendirme yöneticisi.
 * Kök dizinde (prefix'siz) olup tercihi Türkçe olanları /tr'ye yönlendirir.
 */
function LanguageRedirectHandler() {
    ...
    useEffect(() => {
        // Eğer dil Türkçe ise ve URL /tr ile başlamıyorsa yönlendir
        // Sadece prefix'siz ana rotalarda (Root Space) bu kontrolü yapıyoruz
...
/**
 * Uygulama Rotaları.
 * Hem ana dizin hem de /tr/ altında aynı yapı çalışır.
 */
        ...
        return (
            <div className="min-h-screen bg-bg-base flex items-center justify-center">
                <div className="flex flex-col items-center gap-6">
                    <div className="text-brand text-5xl font-black tracking-widest uppercase animate-pulse">
                        {BRAND_NAME}
                    </div>
            ...
            {isAuthPage ? (
                <div className="min-h-screen flex flex-col bg-bg-base relative">
                    <header className="w-full z-50 p-6 md:px-12 flex justify-between items-center mb-8">
                        <LocalizedLink
                            to="/"
                            className="text-brand text-2xl font-black tracking-wider uppercase inline-block hover:scale-105 transition-transform"
                        >
                            {BRAND_NAME}
                        </LocalizedLink>
                    </header>
