...
// Hafızada tutulan token (Deadlock engellemek için)
let _accessToken = null;

/**
 * Oturum açıldığında veya token yenilendiğinde App.jsx tarafından çağrılır.
 */
...
async function request(endpoint, options = {}) {
    ...
    // Artık her istekte Supabase'e sormuyoruz, hafızadaki token'ı kullanıyoruz
    const token = _accessToken;

    // Kullanıcının seçtiği dili backend'e ilet (TMDB dil parametresi için)
...
// Takip Sistemi (Following System)
...
// Dinamik Metadata (Dinamik Türler, Ülkeler vb.)
