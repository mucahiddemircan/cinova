    ...
    <footer className="mt-12 py-12 border-t border-white/10 text-text-secondary text-sm">
      <div className="grid grid-cols-3 lg:grid-cols-4 gap-y-10 gap-x-4 lg:gap-12 mb-12">
        ...
        <div className="col-span-3 lg:col-span-1">
          <LocalizedLink
            href="/"
            className="text-brand text-2xl font-black tracking-wider mb-4 flex items-center gap-2 hover:scale-105 transition-transform w-fit"
          >
        ...
        {/* Platform */}
        <div>
          <h3 className="text-white font-bold mb-4 tracking-wider text-xs">
            {t("footer.platform")}
          </h3>
          <ul className="space-y-3">
            ...
            <li>
              <LocalizedLink
                ...
                className="hover:text-white hover:underline transition-colors"
              >
                {t("footer.popularSeries")}
              </LocalizedLink>
            </li>
            <li>
              <LocalizedLink
                href={user ? `/${user.username}/lists` : "/login"}
                className="hover:text-white hover:underline transition-colors"
              >
                {t("footer.myLists")}
              </LocalizedLink>
