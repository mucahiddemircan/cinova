...
export default function BottomNavigation({ user }) {
    ...
    // useNotifications sadece user varsa çalışır, yoksa default değerler
    let unreadCount = 0;
    try {
        const notifCtx = useNotifications();
        unreadCount = notifCtx.unreadCount;
    } catch {
        // NotificationProvider yoksa (user yoksa) sessizce geç
    }
    ...
    // Mevcut path'i dilden arındırarak kontrol et
