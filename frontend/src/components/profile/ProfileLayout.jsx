...
/**
 * Kullanıcı profili için ortak layout bileşeni.
 * Üst kısımdaki kullanıcı bilgilerini ve sekmeli navigasyonu içerir.
 */
export default function ProfileLayout({ user: currentUser }) {
    ...
    // Görüntülenecek takipçi sayısını hesapla
    ...
    if (loading) {
        return (
            <div className="w-full animate-fade-in">
                ...
                {/* Alt İçerik Skeleton (Grid görünümü simülasyonu) */}
