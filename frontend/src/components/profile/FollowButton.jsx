...
export default function FollowButton({
    ...
    username,
    personId,
    type, // 'user' veya 'person'
    extraData, // Sidebar için name, profile_path vb.
    isFollowing: propFollowing, // Sayfa yüklenirken Context henüz hazır değilse kullanılacak
    size = "md" // 'sm' veya 'md'
}) {
    const { t } = useLanguage();
    ...
    // Eğer Context henüz yükleniyorsa veya boşsa, sayfa verisinden gelen prop'u kullan
