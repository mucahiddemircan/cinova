...
/**
 * Genel amaçlı hata ve bilgilendirme ekranı bileşeni.
 * Cam morfolojisi tasarımı ve minimalist yaklaşım ile hata sayfalarını standartlaştırır.
 */
        ...
        <>
            <div className="min-h-[60vh] flex flex-col items-center justify-center py-12 px-4 text-center animate-fade-in">
                <div className="bg-bg-surface/30 backdrop-blur-md p-10 rounded-[2.5rem] border border-white/5 flex flex-col items-center max-w-md w-full shadow-2xl relative">
                    ...
                    <LocalizedLink
                        to={buttonLink}
                        className="w-full bg-brand hover:bg-brand-hover text-white py-4 px-8 rounded-2xl font-bold transition-all shadow-lg shadow-brand/20 active:scale-[0.98] text-center"
                    >
                        {buttonText}
                    </LocalizedLink>
                </div>
