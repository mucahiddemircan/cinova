...
/**
 * Tasarım sisteminin temel buton bileşeni.
 * 
 * @param {Object} props
 * @param {'primary' | 'secondary' | 'ghost' | 'outline' | 'surface'} props.variant - Buton tipi
 * @param {'sm' | 'md' | 'lg' | 'xl'} props.size - Buton boyutu
 * @param {React.ReactNode} props.icon - Buton ikonu (opsiyonel)
 * @param {boolean} props.fullWidth - Tam genişlik kaplasın mı?
 * @param {string} props.className - Ekstra sınıflar
 */
const Button = ({
  children,
  variant = 'primary',
