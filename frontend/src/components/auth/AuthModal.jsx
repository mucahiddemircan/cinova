                ...
                <div className="flex flex-col items-center text-center gap-6">
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-text-secondary text-sm">
                            Favori içeriklerini takip etmek ve kendi listelerini oluşturmak için oturum aç.
                        </p>
                    </div>
                    ...
                    <div className="flex flex-col w-full gap-3 mt-2">
                        <Link
                            to="/login"
                            onClick={onClose}
                            className="w-full bg-brand hover:bg-brand-hover text-white py-4 rounded-full font-bold text-center transition-all shadow-lg shadow-brand/20 active:scale-[0.98]"
                        >
                            Oturum aç
                        </Link>
                        <button
