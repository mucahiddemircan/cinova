/**
 * Yatay kaydırılabilir içerik listesi bileşeni.
 *
 * Başlık, ileri/geri ok navigasyonu ve sürükle-kaydır desteği sunar.
 * Ana sayfa ve detay sayfalarındaki yatay listelerde kullanılır.
 */
