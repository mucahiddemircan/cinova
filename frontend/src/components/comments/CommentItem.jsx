/**
 * Yorum öğesi bileşeni.
 * Yanıtları, düzenleme ve silme işlemlerini yönetir.
 */
...
export default function CommentItem({ comment, user, onUpdate }) {
    ...
    // Hash-based highlight: URL'deki #comment-{id} ile eşleşen yorumu vurgula
    useEffect(() => {
        ...
        if (targetId === comment.id) {
            // Bu yorum hedef — scroll ve highlight uygula
            ...
            // Hash bu yoruma değil ama yanıtlarımızdan birine ait olabilir — otomatik aç
            setShowReplies(true);
        }
