    ...
    <div className="max-w-4xl mx-auto py-12 px-4 animate-fade-in">
      ...
      <div className="space-y-6 text-text-secondary leading-relaxed text-lg">
        <p>
          ...
          {t("staticPages.about.description")}
        </p>

        <p>{t("staticPages.about.description2")}</p>

        <h2 className="text-xl text-white font-bold mt-10 mb-4">
          {t("staticPages.about.visionTitle")}
        </h2>
        <p>{t("staticPages.about.visionDescription")}</p>

        <h2 className="text-xl text-white font-bold mt-10 mb-4">
          {t("staticPages.about.whyTitle")}
        </h2>
        <ul className="list-disc list-inside space-y-2">
          {Array.isArray(t("staticPages.about.whyList")) &&
            (t("staticPages.about.whyList") as unknown as string[]).map((item, index) => (
