 ...
 *
 * Every notification is clickable and redirects to the relevant page.
...
function NotificationRow({ notification, onClick }) {
    ...
    const handleClick = (e) => {
        // If clicked element is a link or inside a link, do not perform primary redirection
...
export function DesktopNotificationPanel({ isOpen, onClose, toggleRef }) {
    ...
    useEffect(() => {
        const handleClickOutside = (e) => {
            // If panel is closed or click is inside panel or click is inside toggle button, do nothing
            if (!isOpen) return;
