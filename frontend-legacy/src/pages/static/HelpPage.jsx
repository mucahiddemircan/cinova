    ...
    return (
        <div className="bg-bg-surface rounded-xl border border-bg-surface-hover overflow-hidden transition-all duration-300">
            ...
            >
                ...
                <div className={`w-6 h-6 flex items-center justify-center shrink-0 transition-transform duration-300 ${isOpen ? "rotate-45" : "rotate-0"}`}>
...
export default function HelpPage() {
    ...
    const faqs = t("staticPages.help.faqs") || [];

    return (
        <div className="max-w-4xl mx-auto py-12 px-4 animate-fade-in">
            <h1 className="text-3xl md:text-4xl font-black mb-8 border-b border-bg-surface-hover pb-4">{t("staticPages.help.title")}</h1>

            <div className="space-y-12">
                <section>
                    <h2 className="text-xl text-white font-bold mb-6">{t("staticPages.help.subtitle")}</h2>
                ...
                <section>
                    <h2 className="text-xl text-white font-bold mb-6">{t("staticPages.help.botTitle")}</h2>
                    <ChatBot />
                </section>

                <section className="bg-bg-surface p-10 rounded-3xl text-center">
                    <h2 className="text-xl text-white font-bold mb-3">{t("staticPages.help.stillHaveQuestions")}</h2>
