...
export default function TermsPage() {
    const { t } = useLanguage();
    const sections = t("staticPages.terms.sections") || [];

    return (
        <div className="max-w-4xl mx-auto py-12 px-4 animate-fade-in">
            <h1 className="text-3xl md:text-4xl font-black mb-8 border-b border-bg-surface-hover pb-4">{t("staticPages.terms.title")}</h1>
            <p className="text-text-secondary mb-12 text-lg leading-relaxed">{t("staticPages.terms.intro")}</p>
