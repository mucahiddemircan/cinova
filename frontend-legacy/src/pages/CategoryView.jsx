...
export default function CategoryView({ user }) {
    ...
    const {
        ...
        enabled: !staticContents, // Do not run query if static data exists
    });

    // Scroll Position Saving (Scroll Restoration)
    ...
    // Infinite Scroll Observer (Sentinel Div)
